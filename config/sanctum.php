...
return [
    ...
    */
    ...
    'scheme' => env('APP_ENV', 'local') === 'production' ? 'https' : null,
    ...
    */
    ...
    | security scanning systems maintained by open source platforms.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The name of the token that will be used for authentication.
    |
    */
